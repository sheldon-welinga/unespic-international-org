    ...
    return (
      <React.Fragment>
        <Row>
          <Col lg={8}>
            <p>
              Please take your time to familiarize yourself with the commitment
              we expect from all Volunteers and the basic requirements for
            ...
            <form onSubmit={this.handleSubmit} className="volunteer-form">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <option value="UNESPIC official website">
                    UNESPIC Official Website
                  </option>
                  ...
                  <option value="Government Ministry Website">
                    Government Ministry Website
                  </option>
                  <option value="Information through a Proffessional Association">
                    Information through a Proffessional Association
                  </option>
